...
(function () {
  ...
  const dimensions = [
    // tints de la línea v2 (teal/petróleo/naranja de "Instituciones Democráticas para el Futuro")
    { id: 'anticipatoria', n: 1, nombre: { es: 'Gobernanza anticipatoria', en: 'Anticipatory governance' }, icon: 'anticipatoria', tint: '#223F4A', soft: '#E4EBED' },
    { id: 'colaborativa', n: 2, nombre: { es: 'Gobernanza colaborativa', en: 'Collaborative governance' }, icon: 'colaborativa', tint: '#4A8D89', soft: '#E6F1F0' },
    { id: 'comunicacional', n: 3, nombre: { es: 'Gobernanza comunicacional', en: 'Communicational governance' }, icon: 'comunicacional', tint: '#E8622D', soft: '#FBE9E1' },
    { id: 'integra', n: 4, nombre: { es: 'Gobernanza íntegra', en: 'Governance with integrity' }, icon: 'integra', tint: '#1F8A7D', soft: '#E2F1EE' },
    { id: 'digital', n: 5, nombre: { es: 'Gobernanza digital', en: 'Digital governance' }, icon: 'digital', tint: '#24586A', soft: '#E2EBEF' },
    { id: 'intergeneracional', n: 6, nombre: { es: 'Gobernanza intergeneracional', en: 'Intergenerational governance' }, icon: 'intergeneracional', tint: '#C74E1F', soft: '#FAEDE6' },
  ];
  ...
  const strings = {
    es: {
      title: 'Repositorio de experiencias',
